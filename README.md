...
```
docker run --rm -it ghcr.io/altima/bitnet
```
to use your own arguments, enter using shell:
```
docker run --rm -it ghcr.io/altima/bitnet sh
...
```
docker run --rm -it -v /some/host/path:/BitNet/models ghcr.io/altima/bitnet sh
